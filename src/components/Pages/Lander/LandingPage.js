...
const LandingPage = () => {
  ...
  const gotopdfCompressor = () => {
    navigate("/pdf-compressor");
  }

  const gotodocCoverts = () =>{
    navigate("/pdf-to-docx")
  }

  const gotodocCompiler = () =>{
    navigate("/code-compiler")
  }
  const gotoQrCodeGenerator = () =>{
  ...
  const gotoBase64Tools = () =>{
    navigate("/base64-tools")
  }

  const gotoUtilityTools = () =>{
    navigate("/utility-tools")
  }

  const gotoMockupTool = () =>{
    navigate("/mockup-tool")
  }
   ...
   {/* <div className="overflow-hidden whitespace-nowrap">
      ...
      <section id="hero" className="hero">
        <div className="hero-text">
          ...
          <button  className="cta-btn" onClick={onContinue}>eXplore</button>
        </div>
      </section>
      ...
      <section id="tools" className="info-container">
        ...
        <div className="info-cards">
         {/* PDF Compressor */}
  <div onClick={gotopdfCompressor} className="cards">
  ...
  <div onClick={gotopdfCompressor} className="cards">
    ...
    <p>Extract text content from your PDF easily.</p>
          ...
          <div onClick = {gotodocCoverts} className="cards">
          ...
          <div onClick = {gotodocCompiler} className="cards">
  ...
  >
    ...
    <option>HTML/CSS/JS</option>
        ...
        <div onClick = {gotoUtilityTools} className="cards">
  ...
  >
    ...
    <option>Lorem Ipsum Generator</option>
          ...
          <div onClick = {gotoMockupTool} className="cards">
          ...
          <div className="cards">
           ...
           {/* Compress Image */}
  <div onClick = {gotoImageTools} className="cards">
    <FontAwesomeIcon icon={faFileImage} className="icon" />
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-about">
            <h3 className="logo"> <img src={logo} alt="TooConvert Logo" height="50" width="50" />TooConvert</h3>
